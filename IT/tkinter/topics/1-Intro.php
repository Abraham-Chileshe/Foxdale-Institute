    ...
    <div class="row g-4">
        ...
        <div style="overflow-y: scroll; height:800px;" class="col-lg-7 col-md-6 wow fadeInUp" data-wow-delay="0.1s">  
            <div class="container-md"><br/>
                ...
                <p>
                    <span class="text-primary">import</span> turtle<br/>
                    <span class="text-primary">import random</span><br />
                    <br/>
                    x <span class="text-danger">=</span> 1<br/>
                    SN <span class="text-danger">=</span> turtle.Screen()<br/>
                    a <span class="text-danger">=</span> turtle.Turtle()<br/>
                    a.speed(100)<br/><br/>

                    i <span class="text-danger">=</span> 0<br/>
                    <span class="text-danger">while</span> x <span class="text-danger"><</span> 256:<br/>

                        <span style="margin-left:25px">r  <span class="text-danger">=</span> random.randint(0,255)</span><br/>
                        <span style="margin-left:25px">g <span class="text-danger">=</span> 100</span><br/>
                        <span style="margin-left:25px">b <span class="text-danger">=</span> 150</span><br/>
                        <br/>
                        <span style="margin-left:25px">a.pencolor(i,g,b)</span><br/>
                        <span style="margin-left:25px">if x <span class="text-danger"><</span>252:</span><br/>
                        <span style="margin-left:50px">a.pensize(1)</span><br/>
                        <span style="margin-left:50px">a.forward(50 <span class="text-danger">+</span> x)</span><br/>
                        <span style="margin-left:50px">a.right(91.5)</span><Br/>
                        <br/>
                        <span style="margin-left:25px">x <span class="text-danger">=</span> x <span class="text-danger">+</span>1</span><br/>
                        <span style="margin-left:25px">i <span class="text-danger">=</span> (i<span class="text-danger">+</span>1)<span class="text-danger">%</span>255</span><br/>    
                        <br/>
                    turtle.done()
                </p>    
            </div>
